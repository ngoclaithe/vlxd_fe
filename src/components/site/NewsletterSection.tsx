      ...
      <div className="relative overflow-hidden rounded-3xl border border-black/10 bg-gradient-to-r from-blue-600 to-cyan-500 p-8 text-white shadow-sm md:p-12 dark:border-white/10">
        <div className="max-w-2xl">
          ...
          <form className="mt-6 flex max-w-md gap-2" onSubmit={(e) => e.preventDefault()}>
            <input className="flex-1 rounded-full border-0 bg-white/90 px-4 py-3 text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none" placeholder="Nhập email của bạn" type="email" required />
