      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-screen-xl items-center justify-between px-4 py-5 text-xs md:px-6">
          ...
          <div className="flex items-center gap-4">
            <a href="#" aria-label="Facebook" className="rounded-md p-1 hover:bg-white/6">
            ...
            <a href="#" aria-label="YouTube" className="rounded-md p-1 hover:bg-white/6">
            ...
            <a href="#" aria-label="LinkedIn" className="rounded-md p-1 hover:bg-white/6">
